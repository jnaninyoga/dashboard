...
export function PartnerTable({ partners }: { partners: PartnerWithRelations[] }) {
	if (!partners.length) {
		return (
			<div className="border-secondary-foreground/10 bg-secondary/5 hover:bg-secondary/10 text-secondary-foreground flex h-64 flex-col items-center justify-center rounded-2xl border-2 border-dashed p-8 text-center transition-all">
			...
			<Table>
				<TableHeader className="bg-sidebar">
					<TableRow className="border-foreground/10 hover:bg-transparent">
						...
						<TableHead className="font-heading font-semibold">Documents</TableHead>
