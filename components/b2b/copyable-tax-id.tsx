...
export function CopyableTaxId({ taxId, className }: CopyableTaxIdProps) {
  ...
  return (
    <InputGroup className={cn("bg-secondary/60 border-secondary-3/20 w-fit rounded-full", className)}>
      ...
      <InputGroupInput
        value={taxId}
        readOnly
        className="text-secondary-foreground/80 w-fit px-0 font-mono text-sm font-medium"
      />
