									...
									>
										...
										<div className="flex items-center gap-3">
											...
											<Checkbox
												...
												className="size-8 rounded-xl border-2 border-green-600/20 bg-white transition-all hover:border-green-600 active:scale-90 data-[state=checked]:border-green-600 data-[state=checked]:bg-green-600"
			...
			<Card className="border-none shadow-sm">
				...
				<CardContent className="space-y-8">
								...
								<div className="grid gap-3 sm:grid-cols-2">
									{section.fields.map((field) => {
										...
										return (
											<div
												key={field.key}
												className="group bg-sidebar/50 hover:border-primary/10 hover:zen-glow-teal flex flex-col gap-1 rounded-2xl border border-transparent p-3 transition-all hover:bg-white sm:col-span-1"
											>
					...
					{Object.keys(intakeData).length === 0 ? (
						<div className="bg-sidebar/30 border-foreground/10 rounded-3xl border border-dashed py-8 text-center">
						...
						<form onSubmit={handleSubmit} className="space-y-6 pt-4">
							...
							<div className="space-y-2">
								...
								<Input
									...
									required
									className="border-foreground/10 h-11 rounded-xl"
								/>
							</div>
					...
					<div className="space-y-3">
						{healthLogs.length === 0 ? (
							...
							healthLogs.map((log) => (
								<div
									key={log.id}
									className="group bg-sidebar/30 hover:border-primary/10 hover:zen-glow-teal flex items-start justify-between gap-4 rounded-2xl border border-transparent p-4 transition-all hover:bg-white"
								>
