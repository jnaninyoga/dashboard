                                    ...
                                    <TableCell className="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem onClick={() => handleToggleArchive(tier)}>
                                                    <Archive className="mr-2 h-4 w-4" />
                                                    Archive
                                                </DropdownMenuItem>
                                                <DropdownMenuItem onClick={() => handleDelete(tier.id)} className="focus:bg-secondary text-red-600 focus:text-red-600 focus:[&_svg]:text-red-600">
                            ...
                            <TableBody>
                                {archivedTiers.map((tier) => (
                                    <TableRow key={tier.id} className="bg-muted/50">
                                        ...
                                        <TableCell>{tier.price} MAD</TableCell>
                                        <TableCell className="text-right">
                                            <Button variant="ghost" size="sm" onClick={() => handleToggleArchive(tier)}>
